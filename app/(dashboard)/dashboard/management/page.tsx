...
export default function ManagementPage() {
  ...
  //======================   FILTERING ENGINE   ===============================
  const filteredManagements = (managements as any[])?.filter(
    (m: any) =>
  ...
  const handleDelete = async (id: string) => {
    if (
      confirm(
        "Are you certain you want to revoke this management appointment? This is a permanent record change.",
      )
    ) {
      try {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <AFModal
        ...
        title={
          editingManagement ? "Amend Appointment" : "New Leadership Appointment"
        }
