...
export default function PrivacyPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-32 max-w-4xl">
      <h1 className="text-4xl font-bold mb-8 text-primary">{t("legal.privacy.title")}</h1>
      <div className="prose prose-lg dark:prose-invert max-w-none text-foreground/70 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mt-12 mb-4 text-foreground">Data Retention</h2>
        <p>
