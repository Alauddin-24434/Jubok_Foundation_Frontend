...
export default function LandingPage() {
  ...
  return (
    <div>
      ...
      <section
        id="projects"
        className="container mx-auto py-12 md:py-24 px-4 md:px-8"
      >
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center pt-2 md:pt-4">
              <Link href="/signup">
                <Button
                  size="lg"
                  variant="secondary"
                  className="w-full sm:w-auto px-6 md:px-10 h-10 md:h-14 text-sm md:text-lg font-bold"
                >
                  {t("cta.joinInvestor")}
                </Button>
              </Link>
              <Link href="/contact">
                <Button
                  size="lg"
                  className="w-full sm:w-auto px-6 md:px-10 h-10 md:h-14 text-sm md:text-lg font-bold border-2 border-primary-foreground/30 bg-transparent hover:bg-primary-foreground/10"
                >
                  {t("cta.supportCause")}
                </Button>
              </Link>
      ...
      <section
        id="contact"
        className="container mx-auto py-24 border-t border-border/50"
      >
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-4xl font-bold mb-4">{t("contact.title")}</h2>
          <p className="text-foreground/60">{t("contact.desc")}</p>
        </div>
      ...
      <section
        id="faq"
        className="container mx-auto py-12 md:py-24 border-t border-border/50"
      >
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 md:mb-16">
          {t("faq.title")}
        </h2>
          ...
          {Array.isArray(faqQuestions) &&
            faqQuestions.map((q, i) => (
              ...
              >
                ...
                <div
                  className={`grid transition-all duration-300 ${expandedFAQ === i ? "grid-rows-[1fr] opacity-100 mt-2 md:mt-4" : "grid-rows-[0fr] opacity-0"}`}
                >
