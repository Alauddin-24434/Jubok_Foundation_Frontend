  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <Card className="bg-emerald-50 border-emerald-200 shadow-sm relative overflow-hidden">
      ...
      <CardContent>
        ...
        <p className="text-[10px] text-emerald-600/70 mt-1 font-medium italic">Net Available Funds</p>
      </CardContent>
    ...
    <Card className="bg-red-50 border-red-200 shadow-sm relative overflow-hidden">
      ...
      <CardContent>
        ...
        <p className="text-[10px] text-red-600/70 mt-1 font-medium italic">Total Outgoing</p>
      </CardContent>
    ...
    <Card className="bg-blue-50 border-blue-200 shadow-sm relative overflow-hidden">
      ...
      <CardContent>
        ...
        <p className="text-[10px] text-blue-600/70 mt-1 font-medium italic">Lifetime Earnings</p>
      </CardContent>
